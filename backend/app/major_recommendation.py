...
def catMajorIndex(db, listIn):
    ...
    subCatCursor = list(db.test.majorCatList.find(
        {}, {"majorCatList": 1, "_id": 0}))
...
def filter_majors(db, user_Ref, userId):
    artAvg = 0
    artCount = 0
    ...
    catDict = [artDict, buisDict, eduDict, healthDict,
               humDict, protDict, stmDict, tradesDict]
