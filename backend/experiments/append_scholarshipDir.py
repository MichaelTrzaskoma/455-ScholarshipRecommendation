# append a scholarship directory based on category -> sub-category -> table index
            ...
            if exception_handler(driver, 14, ".award-info-action-items [href]"):
                ...
                if exception_handler(driver, 13, "scholdescrip"):
                    ...
                    if exception_handler(driver, 7, "ulScholDetails"):
                        ...
                        temp2 = driver.find_element_by_id(
                            "ulScholDetails").text
...
if __name__ == "__main__":
    try:
        ...
        for x in range(0, len(L1_link)):
            ...
            scholarDb.scholarDirectory.insert_one({
                "term": L1_title[x],
                "subTerm": []
            })
            ...
            for y in range(0, len(L2_link)):
                ...
                #     continue
                scholarDb.scholarDirectory.update_one(
                    {"term": L1_title[x]},
                    {'$push': {"subTerm": L2_title[y]}}
                )
