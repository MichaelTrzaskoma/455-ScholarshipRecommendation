...
export default class ViewCollegeSubCate extends React.Component {
  ...
  getDoc = () => {
    let URL = "http://00bd1ae1b950.ngrok.io/api/v1.2/resources/college/view/states/" + this.state.subCate;
    fetch(URL, {
      method: "GET",
      headers: {
  ...
  handleBookmark() {
    ...
    let URL = "http://00bd1ae1b950.ngrok.io/api/v1.2/users/id/"+ this.state.usrInfo.email + "/bookmarks/college/"+ this.state.usrInfo.jwt+ "/"+ this.state.usrInfo.uuid;
