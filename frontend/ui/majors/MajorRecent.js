...
export default function MajorRecent(props) {
  const navigation = useNavigation();

  return <MajorRecentClass {...props} navigation={navigation} />;
}


class MajorRecentClass extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  getRecentViewed = () => {
    ...
    let URL = "<Host IP>/api/v1.2/users/id/" + this.state.usrInfo.email + "/" + this.state.usrInfo.jwt + "/" + this.state.usrInfo.uuid + "/recent/major/5"
    try {
